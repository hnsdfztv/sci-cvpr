...
parser.add_argument('--train_data_path', type=str, default='./data/medium', help='path of train images')
parser.add_argument('--test_data_path', type=str, default='./data/medium', help='path of test images')
